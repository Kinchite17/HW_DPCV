...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss_real = nn.functional.binary_cross_entropy_with_logits(logits_real, labels_real)
    loss_fake = nn.functional.binary_cross_entropy_with_logits(logits_fake, labels_fake)
